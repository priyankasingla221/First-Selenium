...
public class FirstseleniumScript {
	...
	public void sendkeysTest() {
		...
		//Assertion
		WebElement getTextFromMessage = webDriver.findElement(By.cssSelector(".center_column p[class ='alert alert-success']"));
		String actualText=getTextFromMessage.getText();
		Assert.assertEquals(actualText, "Your message has been successfully sent to our team.", "Text doesn't match");
	
		Assert.assertEquals(webDriver.getCurrentUrl(), "http://automationpractice.com/index.php?controller=contact", "Not directed");
